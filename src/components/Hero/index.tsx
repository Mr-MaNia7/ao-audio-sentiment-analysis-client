...
import GetStartedButton from "../Common/GetStarted";
            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                  AOSA - Open source Afan Oromo Sentiment Analysis Tool on Audio Speech
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  AOSA is a free Tool for Sentiment Analysis on Audio Speech in Afan Oromo Language. 
                  It is an open source project that uses Machine Learning to analyze the sentiment of the audio speech.
                </p>
                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                  ...
                  <li>
                    <Link
                      href="https://github.com/Mr-MaNia7/ao-audio-sentiment-analysis"
                      target="_blank"
                ...
                <div>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    AOSA is now available for online use. You can use it for free.
                  </p>
                </div>
